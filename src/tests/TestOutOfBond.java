...
public class TestOutOfBond {
    ...
    MoveImpossibleException, RefillImpossibleException, TurnOffImpossibleException {
        ...
        Move top2 = new Move(200, data.getRobots()[0], Direction.NORD);
        Move top3 = new Move(400, data.getRobots()[0], Direction.NORD);
        Move top4 = new Move(600, data.getRobots()[0], Direction.NORD);
